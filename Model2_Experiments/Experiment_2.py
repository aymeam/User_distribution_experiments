...
def run_model_exp2(oversampling_rate, model_type, vector_type, flag):   
    ...
    for train_index, test_index in cv_object.split(x_text):
        ...
        #oversampling after data partition
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Experiment 2. Replication of the results of the original model taking into account the detected methodological issues')
    ...
    NO_OF_FOLDS = 5
    embed_size = 50
    run_model_exp2(oversampling_rate,  vector_type, embed_size,flag)
